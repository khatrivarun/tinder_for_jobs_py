...
class AppliedJobs(Frame):
    ...
    def createWidgets(self):
        ...
        frameList = []
        my_list = self.join.get_applied_jobs(self.applicant_email_id)
        for val in my_list:
            ...
            Label(frameList[-1], text=nameVar, bg='black', fg='white', width=90, height=3,
                  font=('Chalet New York', 15)).grid(row=0, columnspan=2)

            Label(frameList[-1], text=jobdescVar, bg='black', fg='white', width=90, height=3,
                  font=('Chalet New York', 15)).grid(row=1, columnspan=2)

            Label(frameList[-1], text=statusVar, bg='black', fg='white', width=90, height=3,
